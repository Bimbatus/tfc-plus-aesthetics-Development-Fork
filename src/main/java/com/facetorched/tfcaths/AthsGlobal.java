...
public class AthsGlobal {
	...
	public static final String[] LAND_BIOMES = new String[] {"All","!Ocean","!Hell","!Deep Ocean","!Beach","!Gravel Beach","!Shore"}; // remember to add !Atoll to this list when dunk updates
