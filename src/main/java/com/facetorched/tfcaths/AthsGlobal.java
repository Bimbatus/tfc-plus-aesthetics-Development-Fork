...
public class AthsGlobal {
	...
	public static final String COBBLESTONE_LICHEN_EPIPHYTE = "Cobblestone_Lichen_Brown_Epiphyte";
	public static final String COBBLESTONE_LICHEN_ELLOW = "Cobblestone_Lichen_Yellow";
