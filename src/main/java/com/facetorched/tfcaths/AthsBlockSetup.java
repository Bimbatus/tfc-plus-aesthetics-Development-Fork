...
public class AthsBlockSetup {
	...
	public static void setup() {
		...
		ephedra = plantRegistryHelper(new BlockPlant().setName(AthsGlobal.EPHEDRA).addVarys(new EnumVary[] {EnumVary.FRUIT, EnumVary.SNOW}).setMonthVaryRange(TFC_Time.MAY, TFC_Time.JULY, EnumVary.FRUIT).setRenderID(plantCropRenderID).setScale(2f));
