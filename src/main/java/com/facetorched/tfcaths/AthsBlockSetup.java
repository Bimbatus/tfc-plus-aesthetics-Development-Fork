...
public class AthsBlockSetup {
	...
	public static void setup() {
		...
		pepperVine = plantRegistryHelper(new BlockPlantEpiphyte3d().setExtraNames(AthsGlobal.PEPPER_VINE, "Varegiated").setOverrideModelName("Flowering_Creeper").addVarys(new EnumVary[] {EnumVary.FLOWER, EnumVary.FRUIT}).setPart("Leaf").setPart("Stem").setVaryPart(EnumVary.FLOWER, EnumVary.FRUIT, "Flower").setFlowerMonthRange(TFC_Time.JUNE, TFC_Time.JULY).setMonthVaryRange(TFC_Time.SEPTEMBER, TFC_Time.OCTOBER, EnumVary.FRUIT).setScale(1.5f));
