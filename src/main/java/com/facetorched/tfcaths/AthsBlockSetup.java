...
public class AthsBlockSetup {
	...
	public static void setup() {
		...
		bulrush = plantRegistryHelper(new BlockPlantStraw().setName(AthsGlobal.BULRUSH).addVarys(new EnumVary[] {EnumVary.WINTER, EnumVary.SNOW, EnumVary.FLOWER}).setFlowerMonthRange(TFC_Time.JULY, TFC_Time.SEPTEMBER).setIsWaterPlant().setScale(3.0F));
