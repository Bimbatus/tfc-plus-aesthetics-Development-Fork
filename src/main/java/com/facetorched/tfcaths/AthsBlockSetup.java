...
public class AthsBlockSetup {
	...
	public static void setup() {
		...
		redCatchfly = plantRegistryHelper(new BlockPlantFlower().setName(AthsGlobal.COMMON_CATCHFLY).addVarys(new EnumVary[] {EnumVary.WINTER, EnumVary.SNOW, EnumVary.FLOWER}).setFlowerMonthRange(TFC_Time.JUNE, TFC_Time.SEPTEMBER).setScale(1f));
		...
		//fallen branches
		fallenBranchAcacia = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_ACACIA, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchAsh = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_ASH, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchAspen = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_ASPEN, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchBaobab = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_BAOBAB, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchBirch = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_BIRCH, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchChestnut = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_CHESTNUT, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchDouglasFir = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_DOUGLAS_FIR, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchEbony = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_EBONY, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchHickory = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_HICKORY, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchGhaf = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_GHAF, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchGingko = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_GINGKO, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchJoshua = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_JOSHUA, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchKapok = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_KAPOK, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchLaurel = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_LAUREL, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchLimba = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_LIMBA, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchMahoe = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_MAHOE, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchMangrove = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_MANGROVE, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchMaple = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_MAPLE, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchMahogany = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_MAHOGANY, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchOak = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_OAK, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchPalm = plantRegistryHelper(new BlockPlantTree().setName(AthsGlobal.FALLEN_BRANCH_PALM));
		fallenBranchPine = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_PINE, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchSequoia = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_SEQUOIA, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchSpruce = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_SPRUCE, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchSycamore = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_SYCAMORE, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchTeak = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_TEAK, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchWhiteCedar = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_WHITE_CEDAR, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchWhiteElm = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_WHITE_ELM, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchWillow = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_WILLOW, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		fallenBranchYew = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.FALLEN_BRANCH_YEW, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		driftwood = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.DRIFTWOOD, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
		woodyDebris = plantRegistryHelper(new BlockPlantTree().setNames(AthsGlobal.WOODY_DEBRIS, new String[] {"0","1","2","3"}).setOverrideModelName("Fallen_Branch"));
