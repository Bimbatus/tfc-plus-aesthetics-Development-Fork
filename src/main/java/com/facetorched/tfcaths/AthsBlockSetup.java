...
public class AthsBlockSetup {
	...
	public static void setup() {
		...
		azaleaEvergreen = plantRegistryHelper(new BlockPlantFlower().setNames(AthsGlobal.AZALEA_EVERGREEN, new String[] {"Flame","Lapland","Satsuki"}).addVarys(new EnumVary[] {EnumVary.FLOWER, EnumVary.SNOW}).addIconVary(EnumVary.FLOWER).setIsWoody().setFlowerMonthRange(TFC_Time.MAY, TFC_Time.JULY).setScale(2.0f));
