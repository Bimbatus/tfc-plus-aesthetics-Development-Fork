...
public class AthsBlockSetup {
	...
	public static void setup() {
		...
		poisonIvyEpiphyte = plantRegistryHelper(new BlockPlantEpiphyte3d().setName(AthsGlobal.POISON_IVY_EPIPHYTE).setOverrideModelName("Creeper").setNamedPart("Leaf").setNamedPart("Leaf_Asymmetrical").setNamedPart("Leaf_Jagged").setNamedPart("Stem").setPoisonDuration(8).setScale(1f));
