...
public class AthsBlockSetup {
	...
	public static void setup() {
		...
		clubmoss = plantRegistryHelper(new BlockPlant().setExtraNames(AthsGlobal.CLUBMOSS, "Firmoss","Stiff","Tree","Bog","Southern","Palhinhaea","Staghorn").addVarys(new EnumVary[] {EnumVary.SNOW}).setRenderID(plantCropRenderID).setScale(1f));
		...
		cycad = plantRegistryHelper(new BlockPlantTree3d().setSapling(new ItemStack(ItemSetup.straw)).setNames(AthsGlobal.CYCAD, new String[] {"Male", "Female","Male_Bamboo", "Female_Bamboo","Male_Bread", "Female_Bread","Male_Zamia", "Female_Zamia"}).addVary(EnumVary.FLOWER).setParts(new String[] {"Frond", "Trunk", "Shag"}).setNamedBaseMetaPart(EnumVary.FLOWER, "Cone").setIsAxisAligned().setFlowerMonthRange(TFC_Time.APRIL, TFC_Time.AUGUST).setScale(2.5f));
		cycad2 = plantRegistryHelper(new BlockPlantTree3d().setSapling(new ItemStack(ItemSetup.straw)).setNames(AthsGlobal.CYCAD2, new String[] {"Male_Stangeria", "Female_Stangeria","Male_Dioon", "Female_Dioon"}).addVary(EnumVary.FLOWER).setParts(new String[] {"Frond", "Trunk", "Shag"}).setNamedBaseMetaPart(EnumVary.FLOWER, "Cone").setIsAxisAligned().setFlowerMonthRange(TFC_Time.APRIL, TFC_Time.AUGUST).setScale(2.5f));
