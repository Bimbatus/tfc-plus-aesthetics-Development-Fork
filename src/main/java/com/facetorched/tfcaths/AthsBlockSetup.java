...
public class AthsBlockSetup {
	...
	public static Block makurangiFern;
	...
	public static void setup() {
		...
		sweetFern = plantRegistryHelper(new BlockPlantFlower().setName(AthsGlobal.SWEET_FERN).addVarys(new EnumVary[] {EnumVary.WINTER, EnumVary.SNOW}).setScale(1f));
		...
		leatherleaf = plantRegistryHelper(new BlockPlantFlower().setName(AthsGlobal.LEATHERLEAF).addVarys(new EnumVary[] {EnumVary.FLOWER, EnumVary.SNOW}).setRenderID(plantCropRenderID).setIsWoody().setFlowerMonthRange(TFC_Time.MAY, TFC_Time.JUNE).setScale(1f));
		pepperPlant = plantRegistryHelper(new BlockPlantTreeFlower().setName(AthsGlobal.PEPPER_PLANT).addVarys(new EnumVary[] {EnumVary.FLOWER, EnumVary.FRUIT}).setFlowerMonthRange(TFC_Time.JUNE, TFC_Time.JULY).setMonthVaryRange(TFC_Time.SEPTEMBER, TFC_Time.OCTOBER, EnumVary.FRUIT).setScale(5f));
		...
		pussyWillow = plantRegistryHelper(new BlockPlantTree().setSapling(EnumTree.WILLOW).setNames(AthsGlobal.PUSSY_WILLOW, new String[]{"American","Gray","Goat_Sallow"}).addVarys(new EnumVary[] {EnumVary.AUTUMN, EnumVary.WINTER, EnumVary.SNOW}));
		...
		marattiaFern = plantRegistryHelper(new BlockPlantStraw3d().setName(AthsGlobal.MARATTIA_FERN).setPart("Frond").setScale(1f));
		...
		lipFern = plantRegistryHelper(new BlockPlantStraw3d().setName(AthsGlobal.LIP_FERN).addVary(EnumVary.SNOW).setVaryPart(new EnumVary[] {EnumVary.DEFAULT, EnumVary.SNOW}, "Frond").setScale(1.3f));
		laceLipFern = plantRegistryHelper(new BlockPlantStraw3d().setName(AthsGlobal.LACE_LIP_FERN).addVary(EnumVary.SNOW).setVaryPart(new EnumVary[] {EnumVary.DEFAULT, EnumVary.SNOW}, "Frond").setScale(1.3f));
		starScaledCloakFern = plantRegistryHelper(new BlockPlantStraw3d().setName(AthsGlobal.STAR_SCALED_CLOAK_FERN).addVary(EnumVary.SNOW).setVaryPart(new EnumVary[] {EnumVary.DEFAULT, EnumVary.SNOW}, "Frond").setScale(1.3f));
		paragymnopterisFern = plantRegistryHelper(new BlockPlantStraw3d().setName(AthsGlobal.PARAGYMNOPTERIS_FERN).addVary(EnumVary.SNOW).setVaryPart(new EnumVary[] {EnumVary.DEFAULT, EnumVary.SNOW}, "Frond").setScale(1.3f));
