...
public class AthsBlockSetup {
	...
	public static void setup() {
		...
		caesarMushroom = plantRegistryHelper(new BlockPlantFungus().setNames(AthsGlobal.CAESAR_MUSHROOM, new String[] {"Eurasian","American"}).setBrownMushroom(20f).setScale(0.8f).setSeasonalFungus(TFC_Time.JUNE, TFC_Time.OCTOBER));
		...
		puffball = plantRegistryHelper(new BlockPlant3dFungus().setName(AthsGlobal.PUFFBALL).setPart("Sporocarp").setScale(1.0f).setBrownMushroom(160f).setSeasonalFungus(TFC_Time.SEPTEMBER, TFC_Time.OCTOBER));
		...
		mayapple = plantRegistryHelper(new BlockPlant3dFlower().setName(AthsGlobal.MAYAPPLE).addVarys(new EnumVary[] {EnumVary.AUTUMN, EnumVary.WINTER, EnumVary.FLOWER, EnumVary.SNOW}).setNamedPart("Side").setVaryParts(new EnumVary[] {EnumVary.DEFAULT, EnumVary.FLOWER}, new String[] {"Top", "Underlay"}).setNamedVaryPart(EnumVary.AUTUMN, "Top").setNamedVaryPart(EnumVary.AUTUMN, "Underlay").setFlowerMonthRange(TFC_Time.MAY, TFC_Time.JUNE).setScale(1.3f));
