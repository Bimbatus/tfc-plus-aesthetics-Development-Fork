...
public class AthsBlockSetup {
	...
	public static void setup() {
		...
		hibiscus = plantRegistryHelper(new BlockPlantTreeTrimmableFlower().setNames(AthsGlobal.HIBISCUS, new String[] {"Orange","Pink","Red","White"}).setExtraNames(AthsGlobal.HIBISCUS, "Trimmed").addVary(EnumVary.FLOWER).setIsWoody().addIconVary(EnumVary.FLOWER).setFlowerMonthRange(TFC_Time.JULY, TFC_Time.AUGUST).setScale(6f));
