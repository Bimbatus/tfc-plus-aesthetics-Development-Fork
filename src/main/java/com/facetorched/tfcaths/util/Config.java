...
public class Config {
	...
	public static void reloadPlants() {
		...
		athsPlantHelper(AthsGlobal.TROPICAL_MISTLETOE + "_Tapinathus", AthsGlobal.TROPICAL_MISTLETOE, new int[] {5}, new String[] {"alltrees","terrafirmacraftplus:leaves","terrafirmacraftplus:leaves2","terrafirmacraftplus:leaves3"}, AthsGlobal.LAND_BIOMES, new String[]{"Africa"},
