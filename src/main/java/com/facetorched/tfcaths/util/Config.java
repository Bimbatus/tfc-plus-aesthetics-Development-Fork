...
public class Config {
	...
	public static void reloadPlants() {
		...
		athsPlantHelper(AthsGlobal.TRUMPET_PITCHER /*Cane_Brake*/, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat"}, new String[] {"Swamp","Salt Swamp","Riverbank","Lakeshore","Lake","River"}, new String[]{"Americas"},
		...
		athsPlantHelper(AthsGlobal.TRUMPET_PITCHER + "_Green", AthsGlobal.TRUMPET_PITCHER, new int[] {1}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat"}, new String[] {"Swamp","Salt Swamp","Riverbank","Lakeshore","Lake","River"}, new String[]{"Americas"},
		...
		athsPlantHelper(AthsGlobal.TRUMPET_PITCHER + "_Purple", AthsGlobal.TRUMPET_PITCHER, new int[] {2}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat"}, new String[] {"Swamp","Salt Swamp","Riverbank","Lakeshore","Lake","River"}, new String[]{"Americas"},
		...
		athsPlantHelper(AthsGlobal.TRUMPET_PITCHER + "_Sweet", AthsGlobal.TRUMPET_PITCHER, new int[] {3}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat"}, new String[] {"Swamp","Salt Swamp","Riverbank","Lakeshore","Lake","River"}, new String[]{"Americas"},
		...
		athsPlantHelper(AthsGlobal.YOUNG_SAWARA_FALSECYPRESS, new int[] {0}, new String[] {"ore:blockSoil"}, new String[] {"Swamp","Riverbank","Lakeshore","Mountains","Mountain Range","Mountain Range Edge","Mountains Edge"}, new String[]{"Asia"},
		...
		athsPlantHelper(AthsGlobal.YOUNG_SAWARA_LEMON_THREAD_FALSECYPRESS, new int[] {0}, new String[] {"ore:blockSoil"}, new String[] {"Swamp","Riverbank","Lakeshore","Mountains","Mountain Range","Mountain Range Edge","Mountains Edge"}, new String[]{"Asia"},
		...
		athsPlantHelper(AthsGlobal.YOUNG_SAWARA_BABY_BLUE_FALSECYPRESS, new int[] {0}, new String[] {"ore:blockSoil"}, new String[] {"Swamp","Riverbank","Lakeshore","Mountains","Mountain Range","Mountain Range Edge","Mountains Edge"}, new String[]{"Asia"},
				/*size*/8, /*dispersion*/10, /*rarity*/10980, /*minAltitude*/160, /*maxAltitude*/255, /*minTemp*/10f, /*maxTemp*/17f, /*minRain*/780f, /*maxRain*/1850f, /*minEVT*/0.25f, /*maxEVT*/2f);
		...
		athsPlantHelper(AthsGlobal.LILAC_BOLETE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Foothills","Lakeshore","Riverbank","Swamp"}, new String[]{"Americas", "Asia"},
		...
		athsPlantHelper(AthsGlobal.GHOST_BOLETE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  new String[] {"Swamp","Salt_Swamp","Riverbank","Lakeshore"}, new String[]{"Americas","Europe","Asia"},
		...
		athsPlantHelper(AthsGlobal.BRASS_BUTTONS, new int[] {0}, new String[] {"ore:blockSand","ore:blockGravel"}, new String[]{"Beach","Gravel Beach","Shore","Estuary","Swamp","Salt_Swamp"}, new String[]{"Africa"},
		...
		athsPlantHelper(AthsGlobal.SWITCHGRASS, new int[] {0,1,2}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","High Hills","Mountains","Rolling Hills","High Hills Edge","Foothills","Mountain Range Edge","Mountain Range","High Plains"}, new String[]{"Americas"},
				/*size*/100, /*dispersion*/4, /*rarity*/7128, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/0f, /*maxTemp*/18f, /*minRain*/200f, /*maxRain*/750f, /*minEVT*/0f, /*maxEVT*/2f,/*forestGen*/-1.0f);
		athsPlantHelper(AthsGlobal.MEADOW_FESCUE, new int[] {0,1,2}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","High Hills","Mountains","Rolling Hills","High Hills Edge","Foothills","Mountain Range Edge","Mountain Range","High Plains"}, new String[]{"Europe"},
		...
		athsPlantHelper(AthsGlobal.COCKS_FOOT, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","High Hills","Rolling Hills","High Hills Edge","Swamp","Riverbank","Lakeshore"}, new String[]{"Asia", "Africa", "Europe"},
				/*size*/60, /*dispersion*/4, /*rarity*/6528, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/9f, /*maxTemp*/25, /*minRain*/190f, /*maxRain*/850f, /*minEVT*/0f, /*maxEVT*/2f,/*forestGen*/-1.0f);
		...
		athsPlantHelper(AthsGlobal.BUFFALOGRASS, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","High Hills","Rolling Hills","High Hills Edge","High Plains"}, new String[]{"Americas"},
				/*size*/100, /*dispersion*/4, /*rarity*/4128, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/0f, /*maxTemp*/18f, /*minRain*/200f, /*maxRain*/500, /*minEVT*/0f, /*maxEVT*/2f,/*forestGen*/-1.0f);
		athsPlantHelper(AthsGlobal.BLUE_GRAMA, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","High Hills","Rolling Hills","High Hills Edge","High Plains"}, new String[]{"Americas"},
				/*size*/100, /*dispersion*/4, /*rarity*/4128, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/0f, /*maxTemp*/18f, /*minRain*/200f, /*maxRain*/500, /*minEVT*/0f, /*maxEVT*/2f,/*forestGen*/-1.0f);
		athsPlantHelper(AthsGlobal.AFRICAN_BRISTLE_GRASS, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","High Hills","Rolling Hills","High Hills Edge","High Plains"}, new String[]{"Africa"},
				/*size*/100, /*dispersion*/4, /*rarity*/4128, /*minAltitude*/146, /*maxAltitude*/255, /*minTemp*/0f, /*maxTemp*/18f, /*minRain*/300f, /*maxRain*/850f, /*minEVT*/0f, /*maxEVT*/2f,/*forestGen*/-1.0f);
		athsPlantHelper(AthsGlobal.AFRICAN_BRISTLE_GRASS, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","High Hills","Rolling Hills","High Hills Edge","High Plains"}, new String[]{"Africa"},
		...
		athsPlantHelper(AthsGlobal.PURPLE_MOOR_GRASS, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","Swamp","Lakeshore","Peat Bog"}, new String[]{"Asia", "Europe","Africa"},
		...
		athsPlantHelper(AthsGlobal.BOG_ASPHODEL, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","Swamp","Lakeshore","Peat Bog"}, new String[]{"Europe"},
		...
		athsPlantHelper(AthsGlobal.POISON_HEMLOCK + "_Water_Hemlock", AthsGlobal.POISON_HEMLOCK, new int[] {1}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","Swamp","Lakeshore","Riverbank","Rolling Hills"}, new String[]{"Europe","Americas"},
		...
		athsPlantHelper(AthsGlobal.WOLFS_BANE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String [] {"Mountains","High Hills","Mountain Range","Mountains Edge","Mountain Range Edge","High Hills Edge","Foothills"}, new String[]{"Europe","Americas","Asia"},
