...
public class Config {
	...
	public static void reloadPlants() {
		...
		athsPlantHelper(AthsGlobal.CHUSQUEA, new int[] {0}, new String[] {"ore:blockSoil","ore:blockSand","ore:blockGravel"}, new String[]{"Foothills","Mountains Edge","Mountains","Mountain Range Edge","Mountain Range"}, new String[]{"Americas"},
		...
		athsPlantHelper(AthsGlobal.CHUSQUEA + "_Lowland", AthsGlobal.CHUSQUEA, new int[] {0, 1}, new String[] {"ore:blockSoil","ore:blockSand","ore:blockGravel"}, new String[]{"Plains","Swamp","Peat Bog","Riverbank","Lakeshore","Rolling Hills"}, new String[]{"Americas"},
				/*size*/30, /*dispersion*/2, /*rarity*/5380, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/9f, /*maxTemp*/18f, /*minRain*/800f, /*maxRain*/4020f, /*minEVT*/0f, /*maxEVT*/5f);
