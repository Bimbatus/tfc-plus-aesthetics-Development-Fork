...
public class Config {
	...
	public static void reloadPlants() {
		...
		athsPlantHelper(AthsGlobal.CYCAD2 + "_Bamboo", AthsGlobal.CYCAD2, new int[] {2,3}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
		...
		athsPlantHelper(AthsGlobal.CYCAD + "_Dioon", AthsGlobal.CYCAD, new int[] {2,3}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Lake","Foothills","Lakeshore","Riverbank","Swamp"}, new String[]{"Americas"},
