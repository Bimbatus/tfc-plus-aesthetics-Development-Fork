...
public class Config {
	...
	public static void reloadPlants() {
		...
		athsPlantHelper(AthsGlobal.CLUBMOSS + "_Stiff", AthsGlobal.CLUBMOSS, new int[] {2}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia","Americas","Europe"},
				/*size*/29, /*dispersion*/8, /*rarity*/4584, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/0, /*minTemp*/-20f, /*maxTemp*/13f, /*minRain*/810f, /*maxRain*/16000f, /*minEVT*/1f, /*maxEVT*/10f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.CLUBMOSS + "_Palhinhaea", AthsGlobal.CLUBMOSS, new int[] {7}, new String[] {"ore:blockSoil","ore:stone","ore:blockGravel","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia","Americas","Europe"},
		...
		athsPlantHelper(AthsGlobal.CLUBMOSS + "_Staghorn", AthsGlobal.CLUBMOSS, new int[] {7}, new String[] {"ore:blockSoil","ore:stone","ore:blockGravel","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia","Americas","Europe","Africa"},
				/*size*/29, /*dispersion*/8, /*rarity*/4584, /*minAltitude*/155, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/20f, /*maxTemp*/40, /*minRain*/1410f, /*maxRain*/16000f, /*minEVT*/0.25f, /*maxEVT*/10f,/*forestGen*/1.0f);
