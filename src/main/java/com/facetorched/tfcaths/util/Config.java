...
public class Config {
	...
	public static void reloadPlants() {
		...
		athsPlantHelper(AthsGlobal.AFRICAN_MILK_BARREL, new int[] {0}, new String[] {"ore:blockSoil","ore:blockSand"}, AthsGlobal.LAND_BIOMES, new String[]{"Africa"},
				/*size*/12, /*dispersion*/6, /*rarity*/2984, /*minAltitude*/144, /*maxAltitude*/220, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/16f, /*maxTemp*/24f, /*minRain*/60f, /*maxRain*/160f, /*minEVT*/0f, /*maxEVT*/4f);
		...
		athsPlantHelper(AthsGlobal.ALBANIAN_SPURGE, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe"},
				/*size*/8, /*dispersion*/4, /*rarity*/6984, /*minAltitude*/144, /*maxAltitude*/220, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/15f, /*maxTemp*/20f, /*minRain*/150f, /*maxRain*/560f, /*minEVT*/0f, /*maxEVT*/4f);
		...
		athsPlantHelper(AthsGlobal.ALOE_VERA, new int[] {0}, new String[] {"ore:blockSoil","ore:blockSand"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Foothills"}, new String[]{"Asia"},
				/*size*/3, /*dispersion*/2, /*rarity*/834, /*minAltitude*/156, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/15f, /*maxTemp*/40f, /*minRain*/45f, /*maxRain*/130f, /*minEVT*/0f, /*maxEVT*/4f);
		athsPlantHelper(AthsGlobal.ALPINE_JUNIPER + "_Mountain", AthsGlobal.ALPINE_JUNIPER, new int[] {0}, new String[] {"ore:blockSoil","ore:blockSand","ore:blockGravel","ore:stone"},  new String[] {"Mountains","Mountain Range","Mountains Edge","Mountain Range Edge", "Foothills"}, new String[]{"Americas","Asia","Europe","Africa"},
				/*size*/15, /*dispersion*/15, /*rarity*/2900, /*minAltitude*/170, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-20f, /*maxTemp*/14f, /*minRain*/150f, /*maxRain*/2000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/0.6f);
		athsPlantHelper(AthsGlobal.ALPINE_JUNIPER, new int[] {0}, new String[] {"ore:blockSoil","ore:blockSand","ore:blockGravel","ore:stone"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas","Asia","Europe","Africa"},
				/*size*/15, /*dispersion*/15, /*rarity*/2900, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-20f, /*maxTemp*/7f, /*minRain*/150f, /*maxRain*/2000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/0.6f);
		...
		athsPlantHelper(AthsGlobal.ANEMONE + "_Broadleaf", AthsGlobal.ANEMONE, new int[] {1}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe"},
				/*size*/5, /*dispersion*/2, /*rarity*/5884, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/9f, /*maxTemp*/19f, /*minRain*/380f, /*maxRain*/1100f, /*minEVT*/0f, /*maxEVT*/6f,/*forestGen*/0.2f);
		athsPlantHelper(AthsGlobal.ANEMONE + "_Poppy", AthsGlobal.ANEMONE, new int[] {2}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe"},
				/*size*/5, /*dispersion*/2, /*rarity*/4884, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/11f, /*maxTemp*/21f, /*minRain*/380f, /*maxRain*/1100f, /*minEVT*/0f, /*maxEVT*/6f,/*forestGen*/0.2f);
		athsPlantHelper(AthsGlobal.ANEMONE + "_Thimbleweed", AthsGlobal.ANEMONE, new int[] {3}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
				/*size*/5, /*dispersion*/2, /*rarity*/5884, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/10f, /*maxTemp*/17f, /*minRain*/680f, /*maxRain*/1600f, /*minEVT*/0f, /*maxEVT*/6f,/*forestGen*/0.2f);
		athsPlantHelper(AthsGlobal.ANEMONE /*Balkan*/, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe","Asia"},
				/*size*/5, /*dispersion*/2, /*rarity*/5884, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/10f, /*maxTemp*/18f, /*minRain*/380f, /*maxRain*/1100f, /*minEVT*/0f, /*maxEVT*/6f,/*forestGen*/0.2f);
		athsPlantHelper(AthsGlobal.ANGELS_TRUMPET + "_Pink", AthsGlobal.ANGELS_TRUMPET, new int[] {1}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","High Hills Edge","Foothills","Mountains Edge","Mountains","Mountain Range","Mountain Range Edge"}, new String[]{"Americas"},
				/*size*/6, /*dispersion*/15, /*rarity*/1084, /*minAltitude*/170, /*maxAltitude*/220, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/22f, /*maxTemp*/40f, /*minRain*/900f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/10f);
		athsPlantHelper(AthsGlobal.ANGELS_TRUMPET + "_White", AthsGlobal.ANGELS_TRUMPET, new int[] {2}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","High Hills Edge","High Plains","Foothills","Mountains Edge","Mountains","Mountain Range","Mountain Range Edge"}, new String[]{"Americas"},
				/*size*/6, /*dispersion*/15, /*rarity*/1084, /*minAltitude*/150, /*maxAltitude*/220, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/20f, /*maxTemp*/35f, /*minRain*/1000f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/10f);
		...
		athsPlantHelper(AthsGlobal.ARPOPHYLLUM_GIGANTEUM, new int[] {0}, new String[] {"alltrees"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
		        /*size*/1, /*dispersion*/1, /*rarity*/2300, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/20f, /*maxTemp*/40f, /*minRain*/980f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.ARROWROOT, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
				/*size*/6, /*dispersion*/8, /*rarity*/4800, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/22f, /*maxTemp*/40f, /*minRain*/1500f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.ASTER + "_Alpine", AthsGlobal.ASTER, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"Mountains","Mountains Edge","Mountain Range","Mountain Range Edge","Foothills","High Hills"}, new String[]{"Europe","Americas"},
				/*size*/5, /*dispersion*/2, /*rarity*/7184, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-6f, /*maxTemp*/10f, /*minRain*/500f, /*maxRain*/900f, /*minEVT*/0f, /*maxEVT*/6f,/*forestGen*/0f);
		athsPlantHelper(AthsGlobal.ASTER, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe","Asia"},
				/*size*/5, /*dispersion*/2, /*rarity*/3884, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/10f, /*maxTemp*/18f, /*minRain*/500f, /*maxRain*/900f, /*minEVT*/0f, /*maxEVT*/6f,/*forestGen*/0f);
		...
		athsPlantHelper(AthsGlobal.AZALEA_DECIDUOUS + "_Swamp", AthsGlobal.AZALEA_DECIDUOUS, new int[] {1}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Lake","Foothills","Lakeshore","Riverbank","Swamp","Peat Bog"}, new String[]{"Asia","Europe"},
				/*size*/6, /*dispersion*/6, /*rarity*/3980, /*minAltitude*/0, /*maxAltitude*/200, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/5f, /*maxTemp*/15f, /*minRain*/750f, /*maxRain*/2000f, /*minEVT*/1f, /*maxEVT*/5f,/*forestGen*/0.5f);
		athsPlantHelper(AthsGlobal.AZALEA_DECIDUOUS /*Honeysuckle*/, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Riverbank","Swamp","Peat Bog"}, new String[]{"Asia","Europe"},
				/*size*/6, /*dispersion*/6, /*rarity*/3980, /*minAltitude*/0, /*maxAltitude*/200, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/10f, /*maxTemp*/18f, /*minRain*/650f, /*maxRain*/1400f, /*minEVT*/1f, /*maxEVT*/5f);
		athsPlantHelper(AthsGlobal.AZALEA_EVERGREEN + "_Lapland", AthsGlobal.AZALEA_EVERGREEN, new int[] {1}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","Plains","High Hills Edge","Mountains","Rolling Hills","Lakeshore","Riverbank","Swamp","Peat Bog","Mountain Range","Mountain Range Edge","High Plains","Lake","Foothills"}, new String[]{"Americas"},
				/*size*/12, /*dispersion*/9, /*rarity*/4980, /*minAltitude*/150, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-15f, /*maxTemp*/5f, /*minRain*/250f, /*maxRain*/850f, /*minEVT*/1f, /*maxEVT*/5f);
		athsPlantHelper(AthsGlobal.AZALEA_EVERGREEN + "_Satsuki", AthsGlobal.AZALEA_EVERGREEN, new int[] {2}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Lake","Foothills","Lakeshore","Riverbank","Swamp","Peat Bog"}, new String[]{"Asia"},
				/*size*/6, /*dispersion*/6, /*rarity*/3980, /*minAltitude*/0, /*maxAltitude*/200, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/11f, /*maxTemp*/19f, /*minRain*/750f, /*maxRain*/2000f, /*minEVT*/1f, /*maxEVT*/5f,/*forestGen*/0.5f);
		athsPlantHelper(AthsGlobal.AZALEA_EVERGREEN /*Flame*/, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","High Hills Edge","Mountains","Mountain Range","Mountain Range Edge","High Plains","Lake","Foothills"}, new String[]{"Americas"},
				/*size*/6, /*dispersion*/6, /*rarity*/3980, /*minAltitude*/150, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/5f, /*maxTemp*/15f, /*minRain*/750f, /*maxRain*/2000f, /*minEVT*/1f, /*maxEVT*/5f,/*forestGen*/0.5f);
		...
		athsPlantHelper(AthsGlobal.BASEBALL_PLANT, new int[] {0}, new String[] {"ore:blockSoil","ore:blockSand"}, AthsGlobal.LAND_BIOMES, new String[]{"Africa"},
				/*size*/10, /*dispersion*/7, /*rarity*/1780, /*minAltitude*/0, /*maxAltitude*/190, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/9f, /*maxTemp*/23f, /*minRain*/75f, /*maxRain*/310f, /*minEVT*/0f, /*maxEVT*/5f);
		athsPlantHelper(AthsGlobal.BASKET_STINKHORN, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Lake","Foothills","Lakeshore","Riverbank","Swamp","Peat Bog"}, new String[]{"Asia","Europe"},
				/*size*/6, /*dispersion*/6, /*rarity*/3980, /*minAltitude*/0, /*maxAltitude*/200, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/0f, /*maxTemp*/16f, /*minRain*/550f, /*maxRain*/1600f, /*minEVT*/1.5f, /*maxEVT*/5f,/*forestGen*/0.1f);
		athsPlantHelper(AthsGlobal.BEAR_CORN, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Lake","Foothills","Lakeshore","Riverbank","Swamp"}, new String[]{"Americas"},
				/*size*/3, /*dispersion*/2, /*rarity*/8980, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-5f, /*maxTemp*/17f, /*minRain*/850f, /*maxRain*/2100f, /*minEVT*/1.5f, /*maxEVT*/5f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.BEGONIA + "_Brevirimosa", AthsGlobal.BEGONIA, new int[] {1}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia"},
				/*size*/14, /*dispersion*/5, /*rarity*/6900, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/26f, /*maxTemp*/40f, /*minRain*/930f, /*maxRain*/16000f, /*minEVT*/1f, /*maxEVT*/10f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.BEGONIA + "_Escargot", AthsGlobal.BEGONIA, new int[] {3}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia"},
				/*size*/14, /*dispersion*/5, /*rarity*/6900, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/18f, /*maxTemp*/32f, /*minRain*/930f, /*maxRain*/16000f, /*minEVT*/1f, /*maxEVT*/10f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.BIRCH_BOLETE + "_Asia", AthsGlobal.BIRCH_BOLETE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"},  new String[] {"Mountains","Mountain Range","Mountains Edge","Mountain Range Edge", "Foothills"}, new String[]{"Asia"},
				/*size*/2, /*dispersion*/2, /*rarity*/5196, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-2f, /*maxTemp*/17f, /*minRain*/350f, /*maxRain*/5500f, /*minEVT*/1f, /*maxEVT*/7f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.BIRCH_POLYPORE, new int[] {0}, new String[] {"birch"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia","Americas","Europe"},
				/*size*/1, /*dispersion*/1, /*rarity*/4500, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-8f, /*maxTemp*/13f, /*minRain*/300f, /*maxRain*/1000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.BIRD_OF_PARADISE, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Africa"},
				/*size*/3, /*dispersion*/3, /*rarity*/7584, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/12f, /*maxTemp*/16f, /*minRain*/600f, /*maxRain*/3000f, /*minEVT*/0f, /*maxEVT*/4f);
		athsPlantHelper(AthsGlobal.BISHOPS_WEED, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia","Europe"},
				/*size*/65, /*dispersion*/1, /*rarity*/5100, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-3f, /*maxTemp*/18f, /*minRain*/670f, /*maxRain*/2000f, /*minEVT*/0.25f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.BITTER_OYSTER, new int[] {0}, new String[] {"oak","birch","maple","hickory","ash","chestnut","pine"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia","Americas","Europe"},
				/*size*/1, /*dispersion*/1, /*rarity*/5500, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/4f, /*maxTemp*/16f, /*minRain*/800f, /*maxRain*/10000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.BLACK_EYED_SUSAN, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
				/*size*/15, /*dispersion*/3, /*rarity*/4884, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/4f, /*maxTemp*/16f, /*minRain*/400f, /*maxRain*/950f, /*minEVT*/0f, /*maxEVT*/6f,/*forestGen*/0.1f);
		...
		athsPlantHelper(AthsGlobal.BLAZING_STAR, new int[] {0,1}, new String[] {"ore:blockSoil"}, new String[]{"Plains","Rolling Hills","Lakeshore","Riverbank","Swamp"}, new String[]{"Americas"},
				/*size*/4, /*dispersion*/2, /*rarity*/4984, /*minAltitude*/0, /*maxAltitude*/160, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-3f, /*maxTemp*/24f, /*minRain*/630f, /*maxRain*/790f, /*minEVT*/0.5f, /*maxEVT*/3f);
		athsPlantHelper(AthsGlobal.BLEEDING_HEARTS, new int[] {0}, new String[] {"ore:blockSoil","ore:blockGravel"}, new String[]{"Mountains","Mountains Edge","Mountain Range","Mountain Range Edge","Foothills","High Hills"}, new String[]{"Asia"},
				/*size*/5, /*dispersion*/2, /*rarity*/5184, /*minAltitude*/0, /*maxAltitude*/190, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-6f, /*maxTemp*/10f, /*minRain*/900f, /*maxRain*/4000f, /*minEVT*/0f, /*maxEVT*/6f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.BLOODROOT, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
				/*size*/12, /*dispersion*/9, /*rarity*/3790, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-3f, /*maxTemp*/17f, /*minRain*/680f, /*maxRain*/1208f, /*minEVT*/0.25f, /*maxEVT*/10f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.BLUEBELL, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"Plains","Rolling Hills","High Plains","High Hills","High Hills Edge","Lakeshore","Riverbank","Swamp"}, new String[]{"Europe"},
				/*size*/200, /*dispersion*/1, /*rarity*/12884, /*minAltitude*/144, /*maxAltitude*/220, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-5f, /*maxTemp*/17f, /*minRain*/850f, /*maxRain*/3060f, /*minEVT*/0f, /*maxEVT*/10f);
		athsPlantHelper(AthsGlobal.BLUE_CEREUS_CACTUS, new int[] {0,1}, new String[] {"ore:blockSoil","ore:blockSand"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Foothills","Mountains Edge"}, new String[]{"Americas"},
				/*size*/5, /*dispersion*/8, /*rarity*/1200, /*minAltitude*/0, /*maxAltitude*/210, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/17f, /*maxTemp*/34f, /*minRain*/55f, /*maxRain*/190f, /*minEVT*/0.5f, /*maxEVT*/4f);
		...
		athsPlantHelper(AthsGlobal.BRACKEN_FERN, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas","Asia","Europe"},
				/*size*/22, /*dispersion*/8, /*rarity*/2568, /*minAltitude*/144, /*maxAltitude*/160, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-10f, /*maxTemp*/30f, /*minRain*/500f, /*maxRain*/1000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/-0.4f);
		athsPlantHelper(AthsGlobal.BRIDAL_CREEPER, new int[] {0}, new String[] {"alltrees"}, AthsGlobal.LAND_BIOMES, new String[]{"Africa"},
				/*size*/15, /*dispersion*/1, /*rarity*/2100, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/9f, /*maxTemp*/19f, /*minRain*/450f, /*maxRain*/920f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.BUCEPHALANDRA, new int[] {0}, new String[] {"terrafirmacraftplus:FreshWaterStationary","terrafirmacraftplus:Ice"}, AthsGlobal.SHALLOW_WATER_BIOMES, new String[]{"Asia"},
				/*size*/64, /*dispersion*/1, /*rarity*/1068, /*minAltitude*/0, /*maxAltitude*/160, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/24f, /*maxTemp*/40f, /*minRain*/1000f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/10f, /*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.BULBLET_FERN, new int[] {0}, new String[] {"ore:stone"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
				/*size*/5, /*dispersion*/2, /*rarity*/650, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-4f, /*maxTemp*/16f, /*minRain*/750f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.BURDOCK, new int[] {0,1}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia","Europe"},
				/*size*/8, /*dispersion*/9, /*rarity*/968, /*minAltitude*/144, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-5f, /*maxTemp*/18f, /*minRain*/450f, /*maxRain*/1500f, /*minEVT*/0f, /*maxEVT*/4f);
		athsPlantHelper(AthsGlobal.BURMA_CREEPER, new int[] {0}, new String[] {"alltrees", "ore:stone"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia"},
				/*size*/15, /*dispersion*/1, /*rarity*/2100, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/21f, /*maxTemp*/40f, /*minRain*/1050f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.BURNING_BUSH, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","Plains","High Hills Edge","Mountains","Rolling Hills","Lakeshore","Riverbank","Swamp","Mountain Range","Mountain Range Edge","High Plains","Lake","Foothills"}, new String[]{"Asia"},
				/*size*/12, /*dispersion*/10, /*rarity*/6980, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-11f, /*maxTemp*/13f, /*minRain*/450f, /*maxRain*/1050f, /*minEVT*/1f, /*maxEVT*/5f);
		...
		athsPlantHelper(AthsGlobal.CAMAS_FLOWER, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
				/*size*/25, /*dispersion*/6, /*rarity*/6384, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-13f, /*maxTemp*/12f, /*minRain*/300f, /*maxRain*/750f, /*minEVT*/0f, /*maxEVT*/2f);
		athsPlantHelper(AthsGlobal.CANADA_WILD_GINGER, new int[] {0}, new String[] {"ore:blockSoil"}, new String[] {"High Hills","High Hills Edge","Plains","Rolling Hills","Estuary","Riverbank","Swamp","Lakeshore"}, new String[]{"Americas"},
				/*size*/43, /*dispersion*/1, /*rarity*/6984, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-2f, /*maxTemp*/14f, /*minRain*/850f, /*maxRain*/1200f, /*minEVT*/0f, /*maxEVT*/3f);
		athsPlantHelper(AthsGlobal.CANARY_CREEPER, new int[] {0}, new String[] {"alltrees", "ore:stone"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
				/*size*/15, /*dispersion*/1, /*rarity*/2100, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/27f, /*maxTemp*/40f, /*minRain*/950f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.CARALLUMA, new int[] {0}, new String[] {"ore:blockSoil", "ore:blockSand"}, AthsGlobal.LAND_BIOMES, new String[]{"Africa", "Asia"},
				/*size*/14, /*dispersion*/5, /*rarity*/3584, /*minAltitude*/144, /*maxAltitude*/220, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/16f, /*maxTemp*/32f, /*minRain*/85f, /*maxRain*/300f, /*minEVT*/0f, /*maxEVT*/6f);
		athsPlantHelper(AthsGlobal.CARNATIONS + "_Helena_Allwood", AthsGlobal.CARNATIONS, new int[] {2}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe"},
				/*size*/5, /*dispersion*/3, /*rarity*/9984, /*minAltitude*/0, /*maxAltitude*/210, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/12f, /*maxTemp*/28f, /*minRain*/420f, /*maxRain*/1100f, /*minEVT*/0.5f, /*maxEVT*/8f);
		athsPlantHelper(AthsGlobal.CARNATIONS + "_Liberty", AthsGlobal.CARNATIONS, new int[] {5}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe"},
				/*size*/5, /*dispersion*/3, /*rarity*/9284, /*minAltitude*/0, /*maxAltitude*/210, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/12f, /*maxTemp*/28f, /*minRain*/420f, /*maxRain*/1100f, /*minEVT*/0.5f, /*maxEVT*/8f);
		athsPlantHelper(AthsGlobal.CARNATIONS + "_Monty's_Pink", AthsGlobal.CARNATIONS, new int[] {4}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe"},
				/*size*/5, /*dispersion*/3, /*rarity*/8484, /*minAltitude*/0, /*maxAltitude*/210, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/12f, /*maxTemp*/28f, /*minRain*/420f, /*maxRain*/1100f, /*minEVT*/0.5f, /*maxEVT*/8f);
		athsPlantHelper(AthsGlobal.CARNATIONS + "_Nahema", AthsGlobal.CARNATIONS, new int[] {3}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe"},
				/*size*/5, /*dispersion*/3, /*rarity*/9684, /*minAltitude*/0, /*maxAltitude*/210, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/12f, /*maxTemp*/28f, /*minRain*/420f, /*maxRain*/1100f, /*minEVT*/0.5f, /*maxEVT*/8f);
		athsPlantHelper(AthsGlobal.CARNATIONS + "_Northland", AthsGlobal.CARNATIONS, new int[] {1}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe"},
				/*size*/5, /*dispersion*/3, /*rarity*/9884, /*minAltitude*/0, /*maxAltitude*/210, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/12f, /*maxTemp*/28f, /*minRain*/420f, /*maxRain*/1100f, /*minEVT*/0.5f, /*maxEVT*/8f);
		athsPlantHelper(AthsGlobal.CARNATIONS + "_Royal_Crimson", AthsGlobal.CARNATIONS, new int[] {6}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe"},
				/*size*/5, /*dispersion*/3, /*rarity*/10284, /*minAltitude*/0, /*maxAltitude*/210, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/12f, /*maxTemp*/28f, /*minRain*/420f, /*maxRain*/1100f, /*minEVT*/0.5f, /*maxEVT*/8f);
		athsPlantHelper(AthsGlobal.CARNATIONS /*Wild*/, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe"},
				/*size*/5, /*dispersion*/3, /*rarity*/6884, /*minAltitude*/0, /*maxAltitude*/210, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/12f, /*maxTemp*/28f, /*minRain*/420f, /*maxRain*/1100f, /*minEVT*/0.5f, /*maxEVT*/8f);
		athsPlantHelper(AthsGlobal.CEYLON_CREEPER + "_Variegated", AthsGlobal.CEYLON_CREEPER, new int[] {1}, new String[] {"alltrees", "ore:stone"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia"},
				/*size*/15, /*dispersion*/1, /*rarity*/3100, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/19f, /*maxTemp*/40f, /*minRain*/950f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.CEYLON_CREEPER, new int[] {0}, new String[] {"alltrees", "ore:stone"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia"},
				/*size*/15, /*dispersion*/1, /*rarity*/2100, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/19f, /*maxTemp*/40f, /*minRain*/950f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.CHIVES, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Lake","Foothills","Lakeshore","Riverbank","Swamp"}, new String[]{"Europe","Asia","Americas"},
				/*size*/8, /*dispersion*/4, /*rarity*/984, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/3f, /*maxTemp*/16f, /*minRain*/600f, /*maxRain*/800f, /*minEVT*/1f, /*maxEVT*/3f);
		athsPlantHelper(AthsGlobal.CHI_NGULU_NGULU, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, AthsGlobal.LAND_BIOMES, new String[]{"Africa"},
				/*size*/4, /*dispersion*/6, /*rarity*/11584, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/22f, /*maxTemp*/40f, /*minRain*/1000f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/4f,/*forestGen*/0.4f);
		...
		athsPlantHelper(AthsGlobal.CHRISTMAS_FERN, new int[] {0}, new String[] {"ore:blockSoil"}, new String[] {"High Hills","High Hills Edge","Plains","Rolling Hills","Estuary","Riverbank","Swamp","Lakeshore"}, new String[]{"Americas"},
				/*size*/13, /*dispersion*/4, /*rarity*/6084, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-1f, /*maxTemp*/18f, /*minRain*/900f, /*maxRain*/1400f, /*minEVT*/1f, /*maxEVT*/5f);
		athsPlantHelper(AthsGlobal.CHRYSANTHEMUM + "Harmony", AthsGlobal.CHRYSANTHEMUM, new int[] {2}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia"},
				/*size*/6, /*dispersion*/4, /*rarity*/5584, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/2f, /*maxTemp*/17f, /*minRain*/500f, /*maxRain*/1800f, /*minEVT*/0f, /*maxEVT*/4f,/*forestGen*/0.1f);
		...
		athsPlantHelper(AthsGlobal.CINNAMON_FERN, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas", "Asia"},
				/*size*/22, /*dispersion*/6, /*rarity*/4068, /*minAltitude*/0, /*maxAltitude*/160, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-5f, /*maxTemp*/20f, /*minRain*/850f, /*maxRain*/8000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/0.8f);
		...
		athsPlantHelper(AthsGlobal.CLIMBING_ROSE, new int[] {0,1,2}, new String[] {"alltrees", "ore:stone"}, new String[]{"Plains","Rolling Hills","Lakeshore","Riverbank","Swamp","Peat Bog","High Hills","High Hills Edge"}, new String[]{"Americas","Asia","Africa","Europe"},
				/*size*/20, /*dispersion*/1, /*rarity*/3600, /*minAltitude*/0, /*maxAltitude*/180, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-5f, /*maxTemp*/22f, /*minRain*/600f, /*maxRain*/900f, /*minEVT*/0.5f, /*maxEVT*/5f);
		...
		athsPlantHelper(AthsGlobal.COBRA_LILY, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[] {"Swamp","Peat Bog","Estuary","Salt Swamp","Lakeshore","Riverbank","Plains"}, new String[]{"Americas"},
				/*size*/7, /*dispersion*/1, /*rarity*/7584, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/11f, /*maxTemp*/21f, /*minRain*/1300f, /*maxRain*/16000f, /*minEVT*/1f, /*maxEVT*/4f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.COMMON_CATCHFLY, new int[] {0,1}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe","Asia","Africa"},
				/*size*/12, /*dispersion*/4, /*rarity*/3284, /*minAltitude*/0, /*maxAltitude*/150, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/11f, /*maxTemp*/22f, /*minRain*/600f, /*maxRain*/890f, /*minEVT*/0.0f, /*maxEVT*/4f);
		...
		athsPlantHelper(AthsGlobal.CORNFLOWER, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe"},
				/*size*/5, /*dispersion*/4, /*rarity*/3350, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/0f, /*maxTemp*/13f, /*minRain*/420f, /*maxRain*/890f, /*minEVT*/0f, /*maxEVT*/1f,/*forestGen*/0.1f);
		athsPlantHelper(AthsGlobal.CRABAPPLE, new int[] {0,1,2,3}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas","Europe","Asia"},
				/*size*/8, /*dispersion*/15, /*rarity*/6000, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/5f, /*maxTemp*/19f, /*minRain*/320f, /*maxRain*/1100f, /*minEVT*/1f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.CRABAPPLE, new int[] {0,1,2,3}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
				/*size*/4, /*dispersion*/15, /*rarity*/7000, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/5f, /*maxTemp*/19f, /*minRain*/320f, /*maxRain*/1100f, /*minEVT*/1f, /*maxEVT*/10f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.CREEPING_BELLFLOWER, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe","Asia"},
				/*size*/25, /*dispersion*/3, /*rarity*/5884, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/8f, /*maxTemp*/24f, /*minRain*/550f, /*maxRain*/1400f, /*minEVT*/0f, /*maxEVT*/6f);
		athsPlantHelper(AthsGlobal.CREEPING_CHARLIE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe"},
				/*size*/35, /*dispersion*/3, /*rarity*/1056, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-6f, /*maxTemp*/33f, /*minRain*/650f, /*maxRain*/1200f, /*minEVT*/0.5f, /*maxEVT*/6f);
		...
		athsPlantHelper(AthsGlobal.CROCUS, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe","Asia","Africa"},
				/*size*/3, /*dispersion*/2, /*rarity*/3084, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/11f, /*maxTemp*/23f, /*minRain*/310f, /*maxRain*/930f, /*minEVT*/0f, /*maxEVT*/6f,/*forestGen*/0f);
		athsPlantHelper(AthsGlobal.CUP_PLANT, new int[] {0,1}, new String[] {"ore:blockSoil"}, new String[]{"Plains","Rolling Hills","Lakeshore","Riverbank","Swamp"}, new String[]{"Americas"},
				/*size*/7, /*dispersion*/2, /*rarity*/4384, /*minAltitude*/0, /*maxAltitude*/160, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/0f, /*maxTemp*/15f, /*minRain*/600f, /*maxRain*/750f, /*minEVT*/0f, /*maxEVT*/3f);
		...
		athsPlantHelper(AthsGlobal.DAFFODIL, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe"},
				/*size*/7, /*dispersion*/3, /*rarity*/7384, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/12f, /*maxTemp*/28f, /*minRain*/280f, /*maxRain*/1300f, /*minEVT*/0f, /*maxEVT*/6f);
		athsPlantHelper(AthsGlobal.DAYLILY + "_Nikkokisuge", AthsGlobal.DAYLILY, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","High Hills Edge","Mountains","Mounatains Edge","Mountain Range Edge","Mountain Range","Foothills","High Plains"}, new String[]{"Asia"},
				/*size*/10, /*dispersion*/2, /*rarity*/6984, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/7f, /*maxTemp*/18f, /*minRain*/480f, /*maxRain*/1100f, /*minEVT*/0f, /*maxEVT*/6f,/*forestGen*/0.2f);
		athsPlantHelper(AthsGlobal.DAYLILY + "_Tawny", AthsGlobal.DAYLILY, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia"},
				/*size*/10, /*dispersion*/2, /*rarity*/5884, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/7f, /*maxTemp*/18f, /*minRain*/480f, /*maxRain*/1100f, /*minEVT*/0f, /*maxEVT*/6f,/*forestGen*/0.2f);
		athsPlantHelper(AthsGlobal.DAYLILY /*Lemon*/, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia", "Europe"},
				/*size*/10, /*dispersion*/2, /*rarity*/6384, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/6f, /*maxTemp*/16f, /*minRain*/480f, /*maxRain*/1100f, /*minEVT*/0f, /*maxEVT*/6f,/*forestGen*/0.2f);
		athsPlantHelper(AthsGlobal.DEADLY_NIGHTSHADE, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia", "Europe"},
				/*size*/12, /*dispersion*/4, /*rarity*/5228, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/4f, /*maxTemp*/16f, /*minRain*/750f, /*maxRain*/6000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.DEADNETTLE, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia","Europe","Africa"},
				/*size*/25, /*dispersion*/1, /*rarity*/4000, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-10f, /*maxTemp*/20f, /*minRain*/590f, /*maxRain*/2450f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/0.2f);
		athsPlantHelper(AthsGlobal.DEATH_CAP, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe"},
				/*size*/2, /*dispersion*/2, /*rarity*/6596, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-6f, /*maxTemp*/13f, /*minRain*/700f, /*maxRain*/4000f, /*minEVT*/0.5f, /*maxEVT*/5f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.DEER_FERN, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","High Hills Edge","Foothills","Swamp","Peat Bog","Mountains","Mountains Edge","Mountain Range Edge","Mountain Range"}, new String[]{"Americas","Asia","Europe"},
				/*size*/18, /*dispersion*/5, /*rarity*/3684, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-10f, /*maxTemp*/14f, /*minRain*/800f, /*maxRain*/2000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.DELTA_MAIDENHAIR_FERN, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
				/*size*/12, /*dispersion*/4, /*rarity*/3300, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/17f, /*maxTemp*/40f, /*minRain*/990f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.DELTA_MAIDENHAIR_FERN_EPIPHYTE, new int[] {0}, new String[] {"alltrees", "ore:stone"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
				/*size*/1, /*dispersion*/1, /*rarity*/1200, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/17f, /*maxTemp*/40f, /*minRain*/990f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.DESTROYING_ANGEL + "_European", AthsGlobal.DESTROYING_ANGEL, new int[] {1}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe"},
				/*size*/2, /*dispersion*/2, /*rarity*/6596, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-14f, /*maxTemp*/19f, /*minRain*/700f, /*maxRain*/4000f, /*minEVT*/0.5f, /*maxEVT*/5f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.DEVILS_CLUB, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
				/*size*/30, /*dispersion*/4, /*rarity*/6084, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-10f, /*maxTemp*/9f, /*minRain*/1000f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/6f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.DEVILS_FINGERS, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Lake","Foothills","Lakeshore","Riverbank","Swamp","Peat Bog"}, new String[]{"Asia"},
				/*size*/4, /*dispersion*/1, /*rarity*/5384, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-4f, /*maxTemp*/18f, /*minRain*/750f, /*maxRain*/3000f, /*minEVT*/0.5f, /*maxEVT*/8f);
		athsPlantHelper(AthsGlobal.DEVILS_TOUNGE, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Lake","Foothills","Lakeshore","Riverbank","Swamp"}, new String[]{"Asia"},
				/*size*/2, /*dispersion*/6, /*rarity*/10096, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/15f, /*maxTemp*/20f, /*minRain*/1200f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.DIAMONDLEAF_FERN, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
				/*size*/10, /*dispersion*/10, /*rarity*/5984, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/14f, /*maxTemp*/40f, /*minRain*/1100f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/4f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.DOLLS_EYES, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"Plains","Rolling Hills","High Plains","High Hills","High Hills Edge","Lakeshore","Riverbank","Swamp"}, new String[]{"Americas"},
				/*size*/6, /*dispersion*/5, /*rarity*/4444, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-11f, /*maxTemp*/6f, /*minRain*/720f, /*maxRain*/3000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.DRYADS_SADDLE, new int[] {0}, new String[] {"whiteelm","ash","maple","willow","aspen","sycamore"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia","Americas","Europe"},
				/*size*/1, /*dispersion*/1, /*rarity*/6000, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/1f, /*maxTemp*/16f, /*minRain*/700f, /*maxRain*/2000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.DUNE_GRASS, new int[] {0}, new String[] {"ore:blockSand","ore:blockGravel"}, new String[]{"Beach","Gravel Beach","Shore","Estuary"}, new String[]{"Americas","Asia"},
				/*size*/12, /*dispersion*/4, /*rarity*/256, /*minAltitude*/145, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/4f, /*maxTemp*/16f, /*minRain*/220f, /*maxRain*/1500f, /*minEVT*/0f, /*maxEVT*/5f);
		athsPlantHelper(AthsGlobal.DWARF_PALMETTO, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Lakeshore","Riverbank","Swamp"}, new String[]{"Americas"},
				/*size*/15, /*dispersion*/16, /*rarity*/4969, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/18f, /*maxTemp*/26f, /*minRain*/600f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/10f);
		...
		athsPlantHelper(AthsGlobal.EASTERN_SKUNK_CABBAGE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Lake","Lakeshore","Riverbank","Swamp","Peat Bog","River"}, new String[]{"Americas"},
				/*size*/43, /*dispersion*/2, /*rarity*/7012, /*minAltitude*/0, /*maxAltitude*/160, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-1f, /*maxTemp*/15f, /*minRain*/750f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/6f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.EGYPTIAN_AUTUMN_CROCUS, new int[] {0}, new String[] {"ore:blockSoil","ore:blockSand"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Lake","Foothills","Lakeshore","Riverbank","Swamp"}, new String[]{"Africa","Europe","Asia"},
				/*size*/6, /*dispersion*/3, /*rarity*/3884, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/17f, /*maxTemp*/26f, /*minRain*/130f, /*maxRain*/300f, /*minEVT*/1f, /*maxEVT*/4f);
		...
		athsPlantHelper(AthsGlobal.ENGLISH_IVY, new int[] {0}, new String[] {"alltrees", "ore:stone"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe"},
				/*size*/15, /*dispersion*/1, /*rarity*/1900, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-8f, /*maxTemp*/19f, /*minRain*/750f, /*maxRain*/3000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.ENOKI /*Enokitake*/, new int[] {0}, new String[] {"willow","birch","whiteelm"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia"},
				/*size*/1, /*dispersion*/1, /*rarity*/4200, /*minAltitude*/0, /*maxAltitude*/185, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/3f, /*maxTemp*/17f, /*minRain*/750f, /*maxRain*/1800f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.ENTOLOMA, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
				/*size*/5, /*dispersion*/3, /*rarity*/6096, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-5f, /*maxTemp*/15f, /*minRain*/900f, /*maxRain*/10000f, /*minEVT*/0f, /*maxEVT*/6f);
		athsPlantHelper(AthsGlobal.EUROPEAN_BEDSTRAW, new int[] {0,1,2}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia", "Europe"},
				/*size*/50, /*dispersion*/3, /*rarity*/3228, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/8f, /*maxTemp*/16f, /*minRain*/750f, /*maxRain*/6000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.POISON_HEMLOCK /*Poison Hemlock*/, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","Swamp","Lakeshore","Riverbank","Rolling Hills"}, new String[]{"Europe","Africa"},
				/*size*/8, /*dispersion*/1, /*rarity*/6528, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/6f, /*maxTemp*/21f, /*minRain*/420f, /*maxRain*/1600/, /*minEVT*/0f, /*maxEVT*/2f,/*forestGen*/0.1f);
		athsPlantHelper(AthsGlobal.POISON_HEMLOCK + "_Water_Hemlock", AthsGlobal.POISON_HEMLOCK, new int[] {1}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","Swamp","Riverbank","Lakeshore","Rolling Hills"}, new String[]{"Europe","Americas"},
				/*size*/8, /*dispersion*/1, /*rarity*/6528, /*minAltitude*/0, /*maxAltitude*/150, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/6f, /*maxTemp*/21f, /*minRain*/420f, /*maxRain*/1600/, /*minEVT*/0f, /*maxEVT*/2f,/*forestGen*/0.1f);
		...
		athsPlantHelper(AthsGlobal.ANGELICA, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","Swamp","Peat Bog","Lakeshore","Rolling Hills","Plains","Peat Bog"}, new String[]{"Asia", "Americas","Europe","Africa"},
				/*size*/15, /*dispersion*/2, /*rarity*/7128, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-13f, /*maxTemp*/14f, /*minRain*/420f, /*maxRain*/950, /*minEVT*/0f, /*maxEVT*/2f,/*forestGen*/0f);
		...
		athsPlantHelper(AthsGlobal.WATER_AVENS, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","Swamp","Lakeshore","Riverbank","Peat Bog"}, new String[]{"Europe","Asia","Americas"},
				/*size*/3, /*dispersion*/1, /*rarity*/5528, /*minAltitude*/0, /*maxAltitude*/155, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/4f, /*maxTemp*/15f, /*minRain*/420f, /*maxRain*/2000/, /*minEVT*/0f, /*maxEVT*/2f,/*forestGen*/0.1f);
		...
		athsPlantHelper(AthsGlobal.LADYS_MANTLE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","Rolling Hills","High Hills","High Hills Edge","Foothills","Mountains Edge","Mountain Range Edge","Plains"}, new String[]{"Asia","Europe"},
				/*size*/10, /*dispersion*/1, /*rarity*/7828, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-8, /*maxTemp*/12f, /*minRain*/520f, /*maxRain*/720, /*minEVT*/0f, /*maxEVT*/2f,/*forestGen*/0f);
		...
		athsPlantHelper(AthsGlobal.GREAT_BURNET, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, AthsGlobal.LAND_BIOMES, new String[]{"Europe","Asia","Americas"},
				/*size*/14, /*dispersion*/7, /*rarity*/5128, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-1, /*maxTemp*/13f, /*minRain*/390f, /*maxRain*/710f, /*minEVT*/0f, /*maxEVT*/5f,/*forestGen*/-0.3f);
		...
		athsPlantHelper(AthsGlobal.LOBELIA /*Blue*/, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"Plains","Rolling Hills","High Hills","High Hills Edge","Mountains Edge","Mountains","Foothills","Swamp","Riverbank","Peat Bog","Lakeshore"}, new String[]{"Europe","Americas","Africa","Asia"},
				/*size*/5, /*dispersion*/5, /*rarity*/4208, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/0f, /*maxTemp*/40f, /*minRain*/567, /*maxRain*/2100, /*minEVT*/0f, /*maxEVT*/10f);
		...
		athsPlantHelper(AthsGlobal.LOBELIA + "_Cardinal",AthsGlobal.LOBELIA, new int[] {2}, new String[] {"ore:blockSoil"}, new String[]{"Plains","Rolling Hills","Swamp","Riverbank","Peat Bog","Lakeshore"}, new String[]{"Americas"},
				/*size*/5, /*dispersion*/5, /*rarity*/6208, /*minAltitude*/0, /*maxAltitude*/160, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/5f, /*maxTemp*/32f, /*minRain*/467, /*maxRain*/4000, /*minEVT*/0f, /*maxEVT*/10f);
		athsPlantHelper(AthsGlobal.LOBELIA + "_Giant",AthsGlobal.LOBELIA, new int[] {3}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","Mountains Edge","Mountains","Foothills","Mountain Range","Mountain Range Edge"}, new String[]{"Africa"},
				/*size*/5, /*dispersion*/5, /*rarity*/3608, /*minAltitude*/170, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/18f, /*maxTemp*/40f, /*minRain*/90, /*maxRain*/340, /*minEVT*/0f, /*maxEVT*/10f);
		athsPlantHelper(AthsGlobal.MARSH_FERN, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"Plains","Rolling Hills","Swamp","Peat Bog"}, new String[]"Americas","Europe","Asia"},
				/*size*/15, /*dispersion*/3, /*rarity*/5208, /*minAltitude*/0, /*maxAltitude*/155, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-3f, /*maxTemp*/15f, /*minRain*/650, /*maxRain*/2500, /*minEVT*/0f, /*maxEVT*/10f);
		...
		athsPlantHelper(AthsGlobal.DWARF_BIRCH, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","ore:stone","ore:blockGravel","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","High Hills","High Plains","Mountains","Mountain Range","Mountains Edge","Mountain Range Edge","Foothills","Rolling Hills","High Hills Edge","Swamp","Riverbank","Lakeshore"}, new String[]{"Asia", "Africa", "Europe"},
				/*size*/8, /*dispersion*/20, /*rarity*/4228, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-20, /*maxTemp*/8, /*minRain*/100f, /*maxRain*/750f, /*minEVT*/0.25, /*maxEVT*/2f,/*forestGen*/-0.5f);
		...
		athsPlantHelper(AthsGlobal.MOSS_CARPET + "_Temperate_Mountains", AthsGlobal.MOSS_CARPET, new int[] {0,1,2}, new String[] {"ore:blockSoil","ore:stone","ore:blockGravel","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Mountains","Mountain Range","Mountain Range Edge"}, new String[]{"Americas", "Asia","Europe","Africa"},
				/*size*/32, /*dispersion*/3, /*rarity*/1568, /*minAltitude*/200, /*maxAltitude*/225, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/-15, /*maxTemp*/17, /*minRain*/750f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/10f, /*forestGen*/1f);
		...
		athsPlantHelper(AthsGlobal.CURVY_STALK_BOLETE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:PeatGrass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
				/*size*/2, /*dispersion*/2, /*rarity*/6796, /*minAltitude*/0, /*maxAltitude*/190, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/1f, /*maxTemp*/18f, /*minRain*/670f, /*maxRain*/1800f, /*minEVT*/0f, /*maxEVT*/7f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.AFRICAN_DREAM_HERB, new int[] {0}, new String[] {"alltrees"}, new String[] {"Salt_Swamp"}, new String[]{"Africa","Asia"},
		...
		athsPlantHelper(AthsGlobal.RATTAN, new int[] {0}, new String[] {"alltrees"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia","Africa"},
		...
		athsPlantHelper(AthsGlobal.YARETA, new int[] {0}, new String[] {"ore:blockSoil","ore:blockSand","ore:blockGravel","ore:stobe"}, new String[]{"Foothills","Mountains Edge","Mountains","Mountain Range Edge","Mountain Range"}, new String[]{"Americas"},
				/*size*/5, /*dispersion*/5, /*rarity*/8380, /*minAltitude*/225, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/10f, /*maxTemp*/27f, /*minRain*/200f, /*maxRain*/920f, /*minEVT*/0f, /*maxEVT*/5f);
		...
		athsPlantHelper(AthsGlobal.GNETUM, new int[] {0}, new String[] {"alltrees"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia","Africa","Americas"},
		...
		athsPlantHelper(AthsGlobal.BOG_RUSH, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:PeatGrass"}, new String[]{"Swamp"","Riverbank","Peat Bog","Lakeshore"}, new String[]{"Asia", "Africa","Americas"},
		...
		athsPlantHelper(AthsGlobal.BOG_RUSH + "_Europe", AthsGlobal.BOG_RUSH, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:PeatGrass"}, new String[]{"Swamp"","Riverbank","Peat Bog","Lakeshore"}, new String[]{"Asia", "Africa","Americas","Europe"},
		...
		athsPlantHelper(AthsGlobal.BOG_RUSH + "_Magellanic", AthsGlobal.BOG_RUSH, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:PeatGrass"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
		...
		athsPlantHelper(AthsGlobal.PATAGONIAN_HORDEUM, new int[] {0}, new String[] {"ore:blockSoil","ore:blockGravel","ore:blockSand"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
		...
		AthsWorldGenPlants.plantList.put("shrub", getPlantData("shrub", Reference.MOD_ID+":"+TFCBlocks.shrub.getUnlocalizedName().substring(5), new int[] {0}, new String[] {"ore:blockSoil","ore:blockSand"}, new String[]{"Riverbank"}, new String[]{"Americas","Europe","Africa","Asia"},
		        /*size*/15, /*dispersion*/10, /*rarity*/1550, /*minAltitude*/0, /*maxAltitude*/255, /*minLatitude*/-32000, /*maxLatitude*/-32000, /*minTemp*/8f, /*maxTemp*/30f, /*minRain*/25f, /*maxRain*/135f, /*minEVT*/0f, /*maxEVT*/4f,/*forestGen*/1.0f));
		for(int i = 0; i < numCustomGenerators; i++) {
			...
			AthsWorldGenPlants.plantList.put(name, getCustomPlantData(name, Reference.MOD_ID+":"+TFCBlocks.undergrowth.getUnlocalizedName().substring(5), new int[] {0}, new String[] {"ore:blockSoil"}, new String[] {"All", "!Hell"}, new String[]{"Americas", "Asia"}, 
					/*size*/3, /*dispersion*/1, /*rarity*/424, /*minAltitude*/0, /*maxAltitude*/180, /*minLatitude*/-32000, /*maxLatitude*/32000, /*minTemp*/0f, /*maxTemp*/40f, /*minRain*/750f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f));
		}
